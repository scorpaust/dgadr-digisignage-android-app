...
const LibFeatScreen = () => {
  ...
  const { images, loading, error } = useStorageImages("destaques_biblio", {
    shuffle: true, // Shuffle library highlights
    autoRefresh: true,
    ...
    return (
      <View style={styles.centerContainer}>
        ...
        <Text style={styles.loadingText}>
          A carregar destaques da biblioteca...
        </Text>
      </View>
    );
  }
  ...
  if (error) {
    return (
      <>
        ...
        />
        <View style={styles.centerContainer}>
          <Text style={styles.errorText}>Erro ao carregar destaques</Text>
        </View>
      </>
    );
  }
